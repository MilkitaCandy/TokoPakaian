...
<head>
    ...
    <style>
        ...
        .hover-scale { transition: transform 1s ease; }
        .hover-scale:hover { transform: scale(1.05); }
        
        .social-icon { transition: transform 0.3s ease; display: inline-block; }
        .social-icon:hover { transform: translateY(-3px); }
        
        .cart-item-hover:hover { background-color: #f8f9fa !important; }
        
        .empty-bag-icon { transition: transform 0.3s ease; display: block; }
        .empty-bag-icon:hover { transform: scale(1.1); }
...
<body class="text-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="d-flex align-items-center gap-4 mt-3 mt-lg-0">
                    ...
                    @auth
                        ...
                        <a href="{{ url('/riwayat') }}" class="text-white text-decoration-none fs-5 transition text-opacity-100-hover opacity-75" title="Riwayat Pesanan">
                            <i class="bi bi-receipt"></i>
                        </a>
                    @endauth
                    
                    <a href="#cartSidebar" data-bs-toggle="offcanvas" class="text-white text-decoration-none transition text-opacity-100-hover opacity-75 d-flex align-items-center" title="Keranjang Belanja">
                        <div class="position-relative mt-1">
                            ...
                            @if($cartCount > 0)
                                <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger border border-dark p-0 d-flex align-items-center justify-content-center" style="font-size: 0.6rem; min-width: 17px; height: 17px; transform: translate(-30%, -20%) !important;">
                                    {{ $cartCount }}
                                </span>
                            @endif
                        </div>
                    ...
                    @auth
                        <a href="{{ url('/logout') }}" class="text-danger text-decoration-none fs-5 transition ms-2 text-opacity-100-hover opacity-75" title="Logout" onclick="return confirm('Yakin mau keluar dari OUT FIT bro?');">
    ...
    <header class="vh-100 d-flex align-items-center position-relative" style="background: linear-gradient(to bottom, rgba(0,0,0,0.6), rgba(0,0,0,0.9)), url('https://images.unsplash.com/photo-1552374196-1ab2a1c593e8?q=80&w=1600&auto=format&fit=crop') no-repeat center center; background-size: cover; background-attachment: fixed;">
        ...
        <div class="row g-0 align-items-center bg-dark text-white shadow-lg">
            ...
            <div class="col-md-6 overflow-hidden">
                <div class="ratio ratio-1x1 h-100">
                    <img src="../img/asset/Editorial.jpg" class="img-fluid w-100 object-fit-cover hover-scale" alt="Editorial">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row mb-5 pb-4 border-bottom border-secondary">
                <div class="col-md-5 mb-4 mb-md-0">
                    ...
                    <div class="d-flex gap-4 mt-4">
                        <a href="#" class="text-white fs-5 transition text-opacity-100-hover opacity-75 social-icon"><i class="bi bi-instagram"></i></a>
                        <a href="#" class="text-white fs-5 transition text-opacity-100-hover opacity-75 social-icon"><i class="bi bi-tiktok"></i></a>
                        <a href="#" class="text-white fs-5 transition text-opacity-100-hover opacity-75 social-icon"><i class="bi bi-twitter-x"></i></a>
                    </div>
                </div>
                <div class="col-md-3 mb-4 mb-md-0">
                    ...
                    <ul class="list-unstyled d-flex flex-column gap-3 small">
                        ...
                        <li><a href="{{ url('/katalog') }}?category=new-arrivals" class="text-secondary text-decoration-none transition text-white-hover">New Arrivals</a></li>
                    </ul>
                </div>
                <div class="col-md-4">
        ...
        <div class="offcanvas-body d-flex flex-column p-0">
            ...
            @if(session('cart') && count(session('cart')) > 0)
                <div class="flex-grow-1 overflow-auto">
                    @foreach(session('cart') as $id => $details)
                        ...
                        <div class="p-3 border-bottom d-flex gap-3 align-items-center transition cart-item-hover" style="background-color: transparent;">
            ...
            @else
                <div class="text-center py-5 my-auto">
                    <i class="bi bi-bag-x display-4 text-secondary opacity-50 mb-3 empty-bag-icon"></i>
